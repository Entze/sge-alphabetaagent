...
public class NodeEvaluation implements Comparable<NodeEvaluation> {
  ...
  public static final NodeEvaluation NEGATIVE_INFINITY = new NodeEvaluation(
      Double.NEGATIVE_INFINITY, Double.NEGATIVE_INFINITY);
  public static final NodeEvaluation POSITIVE_INFINITY = new NodeEvaluation(
  ...
  public NodeEvaluation(Game<?, ?> game, double[] weights) {
    this(game.getUtilityValue(weights), game.getHeuristicValue(weights));
  }
  ...
  public NodeEvaluation(NodeEvaluation nodeEvaluation) {
    this(nodeEvaluation.utility, nodeEvaluation.heuristic);
  }
